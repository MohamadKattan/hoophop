          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text('No driver found',style: TextStyle(fontSize: 22.0,fontFamily: 'bolt-regular'),),
                  ...
                  child: RaisedButton(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('Close',style: TextStyle(color: Colors.black,fontSize: 20.0,fontWeight: FontWeight.bold),),
